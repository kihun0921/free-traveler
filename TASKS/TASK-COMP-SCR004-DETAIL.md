...
task_id: COMP-SCR004-DETAIL
seq: 30
title: 목록+상세 분할/Drawer(Section4)
category: COMPONENT
...
- 이 Task는 `TASKS/00_TASK_LIST.md`(Seq 30)에서 파생되었으며, 라우트 매핑은 `docs/06_SRS_UIUX_REVISED.md` §2를 따른다.
