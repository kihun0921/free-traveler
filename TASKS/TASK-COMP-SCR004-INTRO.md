...
task_id: COMP-SCR004-INTRO
seq: 27
title: Intro+작성 CTA(Section1)
category: COMPONENT
...
- 이 Task는 `TASKS/00_TASK_LIST.md`(Seq 27)에서 파생되었으며, 라우트 매핑은 `docs/06_SRS_UIUX_REVISED.md` §2를 따른다.
