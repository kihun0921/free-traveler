...
task_id: DATA-CONTENT-VALIDATION
seq: 50
title: 콘텐츠 완전성 검증 스크립트
category: DATA
...
- Category: **DATA** / Implementation Status: **IMPLEMENT** / Priority: **P1**
- 이 Task는 `TASKS/00_TASK_LIST.md`(Seq 50)에서 파생되었으며, 라우트 매핑은 `docs/06_SRS_UIUX_REVISED.md` §2를 따른다.
- Verify 방법: CI-LINT-TYPECHECK-UNIT, RELEASE-CONTENT-QA
...
- [ ] `src/data/*.ts`의 수량·필수 필드 완전성을 스크립트로 검사, 미달 시 실패
...
CI-LINT-TYPECHECK-UNIT, RELEASE-CONTENT-QA
