...
- 이 Task는 `TASKS/00_TASK_LIST.md`(Seq 61)에서 파생되었으며, 라우트 매핑은 `docs/06_SRS_UIUX_REVISED.md` §2를 따른다.
- Verify 방법: UNIT-CONTACT-DETECTION
...
- [ ] 전화번호·이메일·메신저 ID 정규식 탐지, 탐지 시 수정 안내 메시지 반환
