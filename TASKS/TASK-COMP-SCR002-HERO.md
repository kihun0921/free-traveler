...
seq: 15
title: free_traveler Hero(Section1)
category: COMPONENT
...
- 이 Task는 `TASKS/00_TASK_LIST.md`(Seq 15)에서 파생되었으며, 라우트 매핑은 `docs/06_SRS_UIUX_REVISED.md` §2를 따른다.
...
- `src/components/about/ProfileHero.tsx`(신규)
...
- [ ] 1440에서 Hero 아래 다음 Section 시작이 보임
