...
seq: 8
title: ?´ì™¸ ?¬í–‰ì§€ Card Grid(Section3)
category: COMPONENT
...
# COMP-SCR001-OVERSEAS-GRID ???´ì™¸ ?¬í–‰ì§€ Card Grid(Section3)

## Context

- Category: **COMPONENT** / Implementation Status: **IMPLEMENT** / Priority: **P0**
- ??Task??`TASKS/00_TASK_LIST.md`(Seq 8)?ì„œ ?Œìƒ?˜ì—ˆ?¼ë©°, ?¼ìš°??ë§¤í•‘?€ `docs/06_SRS_UIUX_REVISED.md` Â§2ë¥??°ë¥¸??
...
- `src/components/destinations/OverseasGrid.tsx`(? ê·œ)
...
- [ ] ?´ì™¸ ??? íƒ ???´ì™¸ ?¬í–‰ì§€ë§??œì‹œ
- [ ] ê°?ì¹´ë“œ???ˆì „?•ë³´ ?íƒœ ë¯¸ë‹ˆ ë°°ì?(ìµœì‹ /?¬í™•???„ìš”)

## Visual AC

- [ ] ìµœì†Œ 6ê°?Card, Desktop 3??Mobile 1??

## Security/Privacy AC

- [ ] ?ˆì „ ë°°ì???amber/critical ? í°ë§??¬ìš©(ì½”ë„ ?¬ì‚¬??ê¸ˆì?)
